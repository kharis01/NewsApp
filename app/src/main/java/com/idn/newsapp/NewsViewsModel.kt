...
class NewsViewsModel : ViewModel() {
    ...
    fun commonMuslimNews() {
        ApiClient.provideApiserivce().getCommonNews()
    ...
    fun aboutAlQuranNews() {
        ApiClient.provideApiserivce().getAlQuranNews()
            .enqueue(object : Callback<NewsResponse> {
                override fun onResponse(
                    call: Call<NewsResponse>,
                    response: Response<NewsResponse>
    ...
    fun alJazeeraNews() {
        ApiClient.provideApiserivce().getAlJazeeraNews()
            .enqueue(object : Callback<NewsResponse> {
                override fun onResponse(
                    call: Call<NewsResponse>,
                    response: Response<NewsResponse>
    ...
    fun warningForMuslimNews() {
        ApiClient.provideApiserivce().getWarningforMuslimNews()
            .enqueue(object : Callback<NewsResponse> {
                override fun onResponse(
                    call: Call<NewsResponse>,
                    response: Response<NewsResponse>
    ...
    fun searchNews(query: String) {
        ApiClient.provideApiserivce().getSearchNews(query)
            .enqueue(object : Callback<NewsResponse> {
                override fun onResponse(
                    call: Call<NewsResponse>,
                    response: Response<NewsResponse>
